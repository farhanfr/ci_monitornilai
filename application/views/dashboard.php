            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="<?php if($this->uri->segment(2) == "dash_kelassaya"){
                            echo 'active';
                        } ?>"> <a class="waves-effect waves-dark" href="<?= base_url('index.php/Con_pengajar/dash_kelassaya');?>" aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Data Pengajar</span></a>
                        </li>

                        <li class="<?php if($this->uri->segment(2) == "dash_kelas_saya"){
                            echo 'active';
                        } ?>"> <a class="waves-effect waves-dark" href="<?= base_url('index.php/Con_pengajar/dash_kelas_saya');?>" aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">Data Siswa</span></a>
                        </li>
